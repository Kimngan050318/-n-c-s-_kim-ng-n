        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    <div class="footer__logo" style="display: flex; justify-content:center; align-items:center; background-color: #fffff7;">
                        <a href="./index.html"><img style="height:90px" src="public/img/sushi_logo.png" alt=""></a>
                    </div>
                    <p>Chào mừng bạn đến với Cute Sushi nơi cung cấp đồ ăn Nhật Bản chất lượng</p>
