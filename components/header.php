<body>
    ...
    <header class="header">
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-2" style="display: flex; align-items: center; justify-content: center;">
                    <div class="header__logo" style="padding: 0; text-align: center;">
                        <a href="index.php"><img style="height: 60px;" src="public/img/sushi_logo.png" alt=""></a>
                    </div>
                </div>
