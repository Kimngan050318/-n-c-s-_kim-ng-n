        ...
        <div class="row">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 10px;">
                        <div class="carousel-item active" >
                            <img class="img-fluid" src="./public/img/banner/am-thuc-nhat-ban-2.jpg" alt="Image" style="height: calc(100vh / 2.56666)">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="./public/img/banner/am-thuc-nhat-ban-1.jpg" alt="Image" style="height: calc(100vh / 2.56666)">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="./public/img/banner/am-thuc-nhat-ban-3.jpg" alt="Image" style="height: calc(100vh / 2.56666)">
            ...
            <div class="col-lg-4">
                <div class="product-offer" >
                    <img class="img-fluid" src="public/img/banner/product-offer-1.jpg" alt="">
                    
                </div>
                <div class="product-offer">
                    <img class="img-fluid" src="public/img/banner/product-offer-2.png" alt="">
...
<!-- Banner Section Begin -->
<section class="banner set-bg" data-setbg="upload/sushi-cute.jpg">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="discount__pic" style="height: 100%;">
                    <img src="upload/merry-christmas-sale.png" style="height: 100%;" alt="Hình ảnh">
                </div>
            </div>
            <div class="col-lg-6 p-0">
                <div class="discount__text" style="padding: 75px 50px 50px;">
